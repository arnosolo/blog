...
title: 黄山
lang: zh-CN
description: 你好, 我是黄山, 来自中国. 我是一名前端工程师. 我会使用 Vue / TS / Unocss 来开发网站.
---
...
- Web端 [vue](https://vuejs.org/) / [react](https://reactjs.org/) + [typescript](https://www.typescriptlang.org/)
  - 熟练使用unocss进行布局, 掌握canvas及svg图形绘制技术

  - 熟练进行状态管理, 生命周期, 组件通讯, 全局状态管理

  - 熟练使用axios进行网络请求

  - 熟练封装第三方库, 如代码编辑器, 图片预览组件

- 熟练使用 [git](https://git-scm.com/doc) 进行版本管理与代码提交, 重视文档的编写
