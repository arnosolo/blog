...
一个简单的3D打印机固件, 我花了两周的时间使用 `c/c++` 编写的. 编写的目原因是对[3D打印机的工作原理](https://arnosolo.github.io/simple-3d-printer/)有一点点好奇. 没有持续改进的原因是, 虽然有趣, 但是感觉靠嵌入式找不到工作. 而如[上文所述](#待业), 我正在为生存而挣扎, 自是没有什么心情去兴趣中陶醉.
